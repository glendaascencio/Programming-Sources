...
<h3> Command Line </h3>
•	Learn Enough Command Line to Be Dangerous: by Michael Hartl Well-written guide that assumes no previous knowledge, and explains jargon. Also contains little exercises to demonstrate the concepts. Highly recommend for beginners.

<h3> Algorithms</h3>
•	Visualgo: Visual learning tool for a bunch of Algorithms and Data Structures. </br>
...
•	A Visual Introduction to Machine Learning: A primer on machine learning for beginners, with helpful visualizations. </br>
...
<h3> Git </h3>
•	Try Git: Never tried git? This interactive tutorial is for you! </br>
•	Github Git Cheatsheet: (PDF) Helpful for those who haven't quite memorized the more frequently-used git commands.</br>
•	Introduction to Git Commits: Step by Step interactive guide to learning how Github works and using Git commands. 

<h3> Python </h3>
•	The Hitchhiker's Guide to Python: An opinionated and thorough guide for getting started in Python.</br>
•	Learn Python The Hard Way: A thorough guide to Python, great for people who have never programmed before.

<h3> Ruby </h3>
•	Try Ruby by Code School: Learn the basics of Ruby in the browser.</br>
•	Ruby Monk: Interactive Ruby tutorials for various levels.</br>
...
<h3> JavaScript </h3>
•	JS the Right Way: A guide intended to introduce new developers to JavaScript.</br>
